...
Namespace BlackCoffee
    ...
    ''' Originated from https://www.developerfusion.com/code/5445/sql-data-provider-vbnet-class/
    ''' </summary>
    Public NotInheritable Class SqlDbMethod
...
#Region "ExecuteFunction"
        ...
        Public Function ExecuteFunction(Of Type)(ByVal udfName As String, ParamArray parameters As SqlParameter()) As Type
            Using connection As SqlConnection = New SqlConnection(ConnectionString)
                Using command As SqlCommand = New SqlCommand(udfName, connection)
                    command.CommandType = CommandType.StoredProcedure
                    command.Parameters.Add("@ReturnValue", TypeToSqlDbType(Of Type)()).Direction = ParameterDirection.ReturnValue
                    ...
                    Return CType(command.Parameters("@ReturnValue").Value, Type)
                End Using
            End Using
        End Function
        ...
        Public Function TypeToSqlDbType(Of Type)() As SqlDbType
            ...
            Else
                Throw New ArgumentException("No mapping from type Type to a SQL data type defined.")
            End If
        End Function
#End Region
